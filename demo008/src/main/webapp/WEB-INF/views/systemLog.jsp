...
<body>
	...
	<table id="systemLog_datagrid">
		<thead>
			<tr>
				<th data-options="field:'opUser',width:1,align:'center',formatter:userFormatter">操作人</th>
				<th data-options="field:'opTime',width:1,align:'center'">操作时间</th>
				<th data-options="field:'opIP',width:1,align:'center'">操作IP</th>
				<th data-options="field:'params',width:1,align:'center'">参数</th>
				<th data-options="field:'function',width:1,align:'center'">操作方法</th>
			</tr>
		</thead>
	</table>
	<!-- 新增编辑对话框 -->
