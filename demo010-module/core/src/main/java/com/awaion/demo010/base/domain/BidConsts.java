...
public class BidConsts {

    public static final int DISPLAY_SCALE = 2;  //显示精度
    public static final int SAVE_SCALE = 4;//存储精度
    public static final int CAL_SCALE = 4;//计算精度

    public static BigDecimal ZERO = new BigDecimal("0.0000"); //小数位保留4位的零


    public static BigDecimal INIT_BORROWLIMIT = new BigDecimal("5000.0000");  //初始信用额度
    ...
    public final static int ACCOUNT_ACTIONTYPE_BID_UNFREEZED = 11;// 资金流水类别：释放投标冻结金额
    public final static int ACCOUNT_ACTIONTYPE_WITHDRAW_FREEZED = 12;// 资金流水类别：提现申请冻结金额
    public final static int ACCOUNT_ACTIONTYPE_WITHDRAW_UNFREEZED = 13;// 资金流水类别：提现申请冻结金额
