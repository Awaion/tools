...
public class RateLimitController {
    ...
    public String byUrl() {
        // http://localhost:10017/rateLimit/byUrl
    ...
    public String byResource() {
        // http://localhost:10017/rateLimit/byResource
    ...
    public String doAction(@PathVariable("p1") Integer p1) {
        // http://localhost:10017/rateLimit/doAction/1
        if (p1 == 0) {
    ...
    public String testHotKey(@RequestParam(value = "p1", required = false) String p1,
        ...
        // http://localhost:10017/testHotKey?p1=qw&p2=we
        // 热点参数限流
        return "------testHotKey";
    }
